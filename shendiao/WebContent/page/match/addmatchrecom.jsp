...
<html>
  <head>
	...
	function addMatchRecom(){
 		
		var programa_id = $("#matchId").val();
		...
		$.ajax({
	 	        url: '${basePath }/match/addMatchRecom.do',
	 	        type: 'POST',
	 	        data: dataForm,
	 	        cache: false,
	 	      	timeout: 60000,
...
<input value="${matchId }" type="hidden" id ="matchId" >
<div style="padding-left: 42% ;font-size:18px;color:red" >添加比赛推荐</div>
	<table cellpadding="5" align="center">
		...
		<tr>
			<td colspan="4" align="right" >
			   <a href="#" class="easyui-linkbutton" id="saveBtn" iconCls="icon-save" onclick="addMatchRecom()">保存</a>
			</td>
