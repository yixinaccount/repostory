...
<html>
  <head>
	...
	function editArticle(){
		...
		var article_id = $("#articleIdHidden").val();
		...
		//创建FormData对象
 	    ...
 	    function(i, file) {
 	   	...
 	   	dataForm.append('article_id',article_id);
		...
		$.ajax({
	 	        url: '${basePath }/rearMethod/editArticle.do',
	 	        type: 'POST',
	 	        data: dataForm,
	 	        cache: false,
	 	      	timeout: 60000,
...
<div style="padding-left: 42% ;font-size:18px;color:red" >修改${articleMap.article_name }</div>
	<input value="${articleMap.article_id }" type="hidden" id="articleIdHidden">
	...
	<table cellpadding="5" align="center">
		...
		<tr>
			...
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="article_name" value="${articleMap.article_name }" data-options="required:true"></td>
	  ...
	  <tr>
		...
		<tr>
			...
			<td colspan="3">
			<textarea rows="" cols="" style="width: 250px" name="article_info" data-options="required:true">${articleMap.article_info }</textarea>
		...
		<tr>
			<td colspan="4" align="right">
			   <a href="#" class="easyui-linkbutton" id="saveBtn" iconCls="icon-save" onclick="editArticle()">保存</a>
			</td>
