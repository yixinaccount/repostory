...
<table id="main" class="easyui-datagrid lines-bottom" title="审核" style="width:100%"
		data-options="rownumbers:true,singleSelect:true,url:'checkList.do',method:'get',toolbar:'#tb',pagination:true,pageNumber:1,
	...
	<thead>
			...
			<thead data-options="frozen:true">
				<tr>
					...
					<th data-options="field:'realname',sortable:true">用户真实姓名</th>
					<th data-options="field:'cellphone'">用户手机号</th>
					<th data-options="field:'IDCard',width:200">用户身份证号</th>
