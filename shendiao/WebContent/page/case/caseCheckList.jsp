...
<html>
  <head>
	...
	function showOpt(val, rec) {
		var str = '';
		str += '<a href="#" style="color:blue" onclick="checkCaseInfo(\''+rec.id+'\',\''+rec.user_id+'\',\''+rec.usercase_id+'\',\''+rec.task_id+'\');">审核</a>&nbsp;&nbsp;&nbsp;&nbsp;'
		/* str += '<a href="#" style="color:blue" onclick="viewAct(\''+rec.act_id+'\');">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;'
		if (rec.state == '1') {
	...
	function checkCaseInfo(id,userId,userCaseId,taskId){
		location.href = "${basePath }/task/checkCasegoto.do?checkCaseId="+id+"&userId="+userId+"&userCaseId="+userCaseId+"&taskId="+taskId;
	}
	...
	function openAddDialog() {
		...
		location.href = "${basePath }/activity/addActgoto.do";
...
<body >
<table id="main" class="easyui-datagrid lines-bottom" title="审核" style="width:100%"
		data-options="rownumbers:true,singleSelect:true,url:'caseCheckList.do',method:'get',toolbar:'#tb',pagination:true,pageNumber:1,
	...
	<thead>
			...
			<thead data-options="frozen:true">
				<tr>
					...
					<th data-options="field:'task_name',sortable:true">任务名称</th>
					<th data-options="field:'task_range'">任务范围</th>
					<th data-options="field:'task_desc',width:200">任务描述</th>
					<th data-options="field:'short_name',width:200">门店名称</th>
					<th data-options="field:'realname',width:200">办案人姓名</th>
...
<!-- <div id="tb" style="padding:2px 5px;">
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="openAddDialog()">添加活动</a>
</div> -->
</body>
</html>
