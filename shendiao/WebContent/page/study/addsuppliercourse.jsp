	...
	function addCourse(){
		...
		//创建FormData对象
	 	...
	 	dataForm.append('course_detail',course_detail);
			//alert("dsfa");
		$.ajax({
	 	        url: '${basePath }/study/addCourse.do',
	 	        type: 'POST',
	 	        data: dataForm,
	 	        cache: false,
	 	      	timeout: 60000,
...
<div style="padding-left: 42% ;font-size:18px;color:red" >添加课程</div>
	<table cellpadding="5" align="center">
	
		<tr>
		
			<td align="right" width=90 class="formtd">课程名称：</td>
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="course_name"  data-options="required:true"></td>
		...
		<tr>
			...
			<td colspan="3">
			<textarea rows="" cols="" style="width: 250px" name="course_info" data-options="required:true"></textarea>
		...
		<tr>
			...
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="course_desc"  data-options="required:true"></td>
		...
		<tr>
			...
			<textarea name="course_detail" id="myEditor" data-options="required:true"></textarea>
				<!-- <script type="text/javascript">
		...
		<tr>
			<td colspan="4" align="right" >
			   <a href="#" class="easyui-linkbutton" id="saveBtn" iconCls="icon-save" onclick="addCourse()">保存</a>
			</td>
