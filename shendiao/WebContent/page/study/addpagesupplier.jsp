...
<html>
  <head>
	...
	function addSupplier(){
		...
		$.ajax({
	 	        url: '${basePath }/supplier/addSupplier.do',
	 	        type: 'POST',
	 	        data: dataForm,
	 	        cache: false,
	 	      	timeout: 60000,
...
<div style="padding-left: 42% ;font-size:18px;color:red" >添加机构</div>
	<table cellpadding="5" align="center">
	
		<tr>
		
			<td align="right" width=90 class="formtd">机构名称：</td>
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="name"  data-options="required:true"></td>
	  ...
	  <tr>
		...
		<tr>
			...
			<td colspan="3">
			<textarea rows="" cols="" style="width: 250px" name="sup_info" data-options="required:true"></textarea>
		...
		<tr>
			...
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:120px" name="type_info"  data-options="required:true"></td>
			<!-- <td >-</td>
		...
		<tr>
			...
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="short_name"  data-options="required:true"></td>
		...
		<tr>
			...
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="telephone"  data-options="required:true"></td>
	 ...
	 <tr>
	  ...
	  <tr>
		...
		<tr>
			...
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="longitude"  data-options="required:true"></td>
		...
		<tr>
			...
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="latitude"  data-options="required:true"></td>
		...
		<tr>
			...
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="contacts"  data-options="required:true"></td>
		...
		<tr>
			...
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="mobile"  data-options="required:true"></td>
		...
		<tr>
			...
			<textarea name="sup_detail" id="myEditor" data-options="required:true"></textarea>
				<!-- <script type="text/javascript">
		...
		<tr>
			<td colspan="4" align="right">
			   <a href="#" class="easyui-linkbutton" id="saveBtn" iconCls="icon-save" onclick="addSupplier()">保存</a>
			</td>
