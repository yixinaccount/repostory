...
<html>
  <head>
	...
	function addCourseRecom(){
 		
		var programa_id = $("#courseId").val();
		...
		$.ajax({
	 	        url: '${basePath }/study/addCourseRecom.do',
	 	        type: 'POST',
	 	        data: dataForm,
	 	        cache: false,
	 	      	timeout: 60000,
...
<div style="padding-left: 42% ;font-size:18px;color:red" >添加课程推荐</div>
	<table cellpadding="5" align="center">
		...
		<tr>
			<td colspan="4" align="right" >
			   <a href="#" class="easyui-linkbutton" id="saveBtn" iconCls="icon-save" onclick="addCourseRecom()">保存</a>
			</td>
