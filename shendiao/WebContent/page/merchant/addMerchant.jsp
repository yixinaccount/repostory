...
<div style="padding-left: 42% ;font-size:18px;color:red" >添加商家</div>
	<table cellpadding="5" align="center">
	
		<tr>
		
			<td align="right" width=90 class="formtd">商家名称：</td>
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="merchant_name"  data-options="required:true"></td>
		
		</tr>
		
		<tr>
		
			<td align="right" width=90 class="formtd">商家简称：</td>
			<td colspan="3"><input class="easyui-textbox" type="text" style="width:300px" name="merchant_shortname"  data-options="required:true"></td>
