  ...
  <head>
	...
	function showOpt(val, rec) {
		...
		//str += '<a href="#" style="color:blue" onclick="checkUserInfo(\''+rec.id+'\');">审核</a>&nbsp;&nbsp;&nbsp;&nbsp;'
		 str += '<a href="#" style="color:blue" onclick="selMerShopList(\''+rec.merchant_id+'\');">查看门店</a>&nbsp;&nbsp;&nbsp;&nbsp;'
		 if (rec.state == '1') {
			str += '<a href="#" style="color:red" onclick="setState(\''+rec.act_id+'\', \'0\', \''+rec.act_name+'\')">禁用</a>&nbsp;&nbsp;&nbsp;&nbsp;'
			str += '<a href="#" style="color:red" onclick="addMerTaskgoto(\''+rec.merchant_id+'\')">添加任务</a>&nbsp;&nbsp;&nbsp;&nbsp;'
		} else {
	...
	function selMerShopList(id){
		location.href = "${basePath }/merchant/shopgoto.do?merchantId="+id;
	}
	
	
	function addMerTaskgoto(id){
		
		location.href = "${basePath }/merchant/addMerTaskgoto.do?merchantId="+id;
	}
	...
	function openAddDialog() {
		...
		location.href = "${basePath }/merchant/addMergoto.do";
...
<body >
<table id="main" class="easyui-datagrid lines-bottom" title="商家列表" style="width:100%"
		data-options="rownumbers:true,singleSelect:true,url:'selMerchantList.do',method:'get',toolbar:'#tb',pagination:true,pageNumber:1,
	...
	<thead>
			...
			<thead data-options="frozen:true">
				<tr>
					...
					<th data-options="field:'merchant_name',sortable:true">商家名称</th>
					...
					<th data-options="field:'address',width:300">商家地址</th>
...
<div id="tb" style="padding:2px 5px;">
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="openAddDialog()">添加商家</a>
</div>
</body>
</html>
